...
namespace KarlTheRobotLibUnitTest
{
    ...
    public static class SpecificationExtensions
    {
        ...
        {
            if (actual != null && expected != null && actual.GetType() == typeof(double) && expected.GetType() == typeof(double))
        ...
        public static void ShouldContainSameAs(this IEnumerable collection, IEnumerable expected)
        {
